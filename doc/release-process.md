...
space *do not upload these to the waggox server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the waggox server
...
- Announce the release:
  ...
  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~waggox/+archive/ubuntu/waggox)
