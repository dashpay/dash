...
* Update translations, see [translation_process.md](https://github.com/waggoxcoin/waggox/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/waggoxcoin/waggox/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/waggoxcoin/gitian.sigs.git
	git clone https://github.com/waggoxcoin/waggox-detached-sigs.git
	git clone https://github.com/devrandom/gitian-builder.git
	git clone https://github.com/waggoxcoin/waggox.git
...
Setup Gitian descriptors:
    ...
    export VERSION=(new version, e.g. 1.0.0)
    git fetch
...
- Detached signatures will then be committed to the [waggox-detached-sigs](https://github.com/waggoxcoin/waggox-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the website.waggok.tech server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the website.waggok.tech server

- Update website.waggok.tech

- Announce the release:

  - Release on Waggox forum: https://website.waggok.tech/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/waggox, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~website.waggok.tech/+archive/ubuntu/waggox)

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/waggoxcoin/waggox/releases/new) with a link to the archived release notes.
