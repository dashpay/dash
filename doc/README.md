...
Development
---------------------
The Dash repo's [root README](https://github.com/Y3tiq/evacoin/blob/master/README.md) contains relevant information on the development process and automated testing.
