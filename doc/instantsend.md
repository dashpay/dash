...
This mechanism has been integrated into Bitcore-Node-Ox which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/oxpay/insight-api-ox#web-socket-api](https://github.com/oxpay/insight-api-ox#web-socket-api) 
* API: [https://github.com/oxpay/insight-api-ox#instantsend-transactions](https://github.com/oxpay/insight-api-ox#instantsend-transactions) 
...
By default, the Ox Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ox Core daemon:
