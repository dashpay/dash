...
This mechanism has been integrated into Bitcore-Node-Kliq which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kliqpay/insight-api-kliq#web-socket-api](https://github.com/kliqpay/insight-api-kliq#web-socket-api) 
* API: [https://github.com/kliqpay/insight-api-kliq#instantsend-transactions](https://github.com/kliqpay/insight-api-kliq#instantsend-transactions) 
...
By default, the Kliq Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Kliq Core daemon:
