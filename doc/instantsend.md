...
This mechanism has been integrated into Bitcore-Node-Gvidon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gvidon/insight-api-gvidon#web-socket-api](https://github.com/gvidon/insight-api-gvidon#web-socket-api) 
* API: [https://github.com/gvidon/insight-api-gvidon#instantsend-transactions](https://github.com/gvidon/insight-api-gvidon#instantsend-transactions) 
...
By default, the Gvidon Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gvidon Core daemon:
