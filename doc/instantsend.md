...
This mechanism has been integrated into Bitcore-Node-Kriss which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/krisscore/insight-api-kriss#web-socket-api](https://github.com/krisscore/insight-api-kriss#web-socket-api)
* API: [https://github.com/krisscore/insight-api-kriss#instantsend-transactions](https://github.com/krisscore/insight-api-kriss#instantsend-transactions)
...
By default, the Kriss Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Kriss Core daemon:
