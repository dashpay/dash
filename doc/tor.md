...
1. Run btx behind a Tor proxy
----------------------------------

The first step is running BTX behind a Tor proxy. This will already make all
...
port 9050 and only allows .onion nodes to connect:
	...
	./btxd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion
...
your btxd's P2P listen port (9999 by default).

	-externalip=X   You can tell btx about its publicly reachable address using
	                this option, and this can be a .onion address. Given the above
	                configuration, you can find your onion address in
	                /var/lib/tor/btx-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./btxd -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./btxd -onion=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -discover


3. List of known btx Tor relays
------------------------------------

* [btxie7ghp67.onion](http://btxie7ghp67.onion/)
