...
config file):
	...
	HiddenServiceDir /var/lib/tor/owncoincore-service/
...
your owncoind's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell Owncoin Core about its publicly reachable address using
	                ...
	                /var/lib/tor/owncoincore-service/hostname. Onion addresses are given
...
Owncoin Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Owncoin Core is listening, and
