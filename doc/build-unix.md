...
This will build jast-qt as well if the dependencies are met.
...
Once these are installed, they will be found by configure and a jast-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip jastd" to strip the debug
