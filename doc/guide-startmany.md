...
[From the jast github repo](https://github.com/microcrm/jastcoin/blob/master/doc/masternode_conf.md)
...
```
mn01 127.0.0.1:93232 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0
mn02 127.0.0.2:93232 93WaAb3htPJEV8E9aQcN23Jt97bPex7YvWfgMDTUdWJvzmrMqey aa9f1034d973377a5e733272c3d0eced1de22555ad45d6b24abadff8087948d4 0
```

## What about the jast.conf file?

If you are using a `masternode.conf` file you no longer need the `jast.conf` file. The exception is if you need custom settings (_thanks oblox_). In that case you **must** remove `masternode=1` from local `jast.conf` file. This option should be used only to start local Hot masternode now.

## Update jast.conf on server

If you generated a new masternode private key, you will need to update the remote `jast.conf` files.

Shut down the daemon and then edit the file.

```nano .jastcore/jast.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `jast.conf` file.
...
and comparing with the official explorer at https://explorer.jast.org/chain/Dash
...
Search your Masternodes on https://jastninja.pl/masternodes.html
