...
Format: ```mngovernance prepare proposal-name url payment-count block-start owncoin-address monthly-payment-owncoin```
...
Format: ```mngovernance submit proposal-name url payment-count block-start owncoin-address monthly-payment-owncoin fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using owncoin.conf setup)
