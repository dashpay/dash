...
Gvidon Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9900.
...
However, in open source software such as Gvidon Core, where everyone uses
...
pay attention to for reviewers of Gvidon Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Gvidon Core uses tinyformat, which is type safe. Leave them out to avoid confusion
