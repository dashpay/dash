...
Only requiring some minor changes is btx.cpp.
...
Changes to btx.cpp
----------------------
btx.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
