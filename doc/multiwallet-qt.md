...
Only requiring some minor changes is gvidon.cpp.
...
Changes to gvidon.cpp
----------------------
gvidon.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
