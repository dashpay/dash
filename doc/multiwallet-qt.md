...
Only requiring some minor changes is kriss.cpp.
...
Changes to kriss.cpp
----------------------
kriss.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
