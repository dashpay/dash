...
Only requiring some minor changes is ox.cpp.
...
Changes to ox.cpp
----------------------
ox.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
