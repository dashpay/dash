...
Only requiring some minor changes is kliq.cpp.
...
Changes to kliq.cpp
----------------------
kliq.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
