...
Only requiring some minor changes is jast.cpp.
...
Changes to jast.cpp
----------------------
jast.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
