...
NOTE: Building with Qt4 is still supported, however, could result in a broken UI. As such, building with Qt5 is recommended. Be aware that Qt5 5.7+ requires C++11 compiler support.
