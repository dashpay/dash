...
official/supported Docker Images found at https://hub.docker.com/r/waggoxproject/waggoxd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/waggoxproject/waggox-develop/ when changing the above text**
