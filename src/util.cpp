...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\WAGGOXCOIN
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\WAGGOXCOIN
    // Mac: ~/Library/Application Support/WAGGOXCOIN
    // Unix: ~/.WAGGOXCOIN
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "WAGGOXCOIN";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/WAGGOXCOIN";
#else
    // Unix
    return pathRet / ".WAGGOXCOIN";
#endif
#endif
}
