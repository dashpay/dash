...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Gvidon Core gvidon-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gvidon-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gvidon transaction") + "\n" +
              "  gvidon-tx [options] -create [commands]   " + _("Create hex-encoded gvidon transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gvidon transaction
