...
static UniValue generatetodescriptor(const JSONRPCRequest& request)
{
    RPCHelpMan{
        ...
        "\nMine blocks immediately to a specified descriptor (before the RPC call returns)\n",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated Dash to."},
...
static UniValue generateblock(const JSONRPCRequest& request)
{
    RPCHelpMan{"generateblock",
        ...
        {
            {"address/descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated Dash to."},
