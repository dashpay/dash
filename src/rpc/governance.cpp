...
static RPCHelpMan gobject_prepare()
{
    return RPCHelpMan{"gobject prepare",
        ...
        + HELP_REQUIRING_PASSPHRASE,
        {
            ...
            {"outputHash", RPCArg::Type::STR_HEX, RPCArg::DefaultHint{""}, "the single output to submit the proposal fee from"},
            {"outputIndex", RPCArg::Type::NUM, RPCArg::DefaultHint{""}, "The output index."},
        },
        RPCResults{},
        RPCExamples{""},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
...
static RPCHelpMan gobject_list_helper(const bool make_a_diff)
{
    ...
    return RPCHelpMan{command,
        description,
        {
            {"signal", RPCArg::Type::STR, RPCArg::DefaultHint{"valid"}, "cached signal, possible values: [valid|funding|delete|endorsed|all]"},
            {"type", RPCArg::Type::STR, RPCArg::DefaultHint{"all"}, "object type, possible values: [proposals|triggers|all]"},
        },
        RPCResults{},
        RPCExamples{""},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
...
static RPCHelpMan gobject_getcurrentvotes()
{
    return RPCHelpMan{"gobject getcurrentvotes",
        ...
        {
            {"governance-hash", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "object id"},
            {"txid", RPCArg::Type::STR_HEX, RPCArg::DefaultHint{""}, "masternode collateral txid"},
            {"vout", RPCArg::Type::STR, RPCArg::DefaultHint{""}, "masternode collateral output index, required if <txid> present"},
        },
        RPCResults{},
        RPCExamples{""},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
