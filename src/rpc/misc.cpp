...
static RPCHelpMan getaddressmempool()
{
    return RPCHelpMan{"getaddressmempool",
        ...
        {
            {"addresses", RPCArg::Type::ARR, RPCArg::DefaultHint{""}, "",
                {
                    {"address", RPCArg::Type::STR, RPCArg::DefaultHint{""}, "The base58check encoded address"},
                },
            },
        },
        RPCResult{
    ...
    return RPCHelpMan{"getspentinfo",
        "\nReturns the txid and index where an output is spent.\n",
        {
            {"request", RPCArg::Type::OBJ, RPCArg::Default{UniValue::VOBJ}, "",
                {
                    {"txid", RPCArg::Type::STR_HEX, RPCArg::DefaultHint{""}, "The hex string of the txid"},
                    {"index", RPCArg::Type::NUM, RPCArg::DefaultHint{""}, "The start block height"},
                },
            },
        },
        RPCResult{
