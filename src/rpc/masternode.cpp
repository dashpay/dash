...
static RPCHelpMan masternode_winners()
{
    return RPCHelpMan{"masternode winners",
        ...
        {
            {"count", RPCArg::Type::NUM, RPCArg::DefaultHint{""}, "number of last winners to return"},
            {"filter", RPCArg::Type::STR, RPCArg::DefaultHint{""}, "filter for returned winners"},
        },
        RPCResults{},
        RPCExamples{""},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
...
static RPCHelpMan masternodelist_helper(bool is_composite)
{
    ...
    return RPCHelpMan{is_composite ? "masternode list" : "masternodelist",
        ...
        "  votingaddress  - Print the masternode voting Dash address\n",
        {
            ...
            {"filter", RPCArg::Type::STR, RPCArg::DefaultHint{""}, "Filter results. Partial match by outpoint by default in all modes, additional matches in some modes are also available"},
        },
        RPCResults{},
        RPCExamples{""},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
