...
// Copyright (c) 2014-2017 The Cadex Core developers
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print cadex address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "cadex",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "cadex",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "cadex",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
