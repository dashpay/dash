    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Kriss Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Kriss Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  kriss-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Kriss in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 KRISS, 0.1 KRISS, 1 KRISS and 10 KRISS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://krisscore.atlassian.net/wiki/display/DOC/PrivateSend\">https://krisscore.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Kriss Core is shutting down...") + "<br /><br />" +
