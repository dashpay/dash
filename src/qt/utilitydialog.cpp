    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Kliq Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Kliq Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  kliq-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Kliq in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 KLIQ, 0.1 KLIQ, 1 KLIQ and 10 KLIQ -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://kliqpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://kliqpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Kliq Core is shutting down...") + "<br /><br />" +
