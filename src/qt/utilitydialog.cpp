    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Ox Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Ox Core"));
...
All the Ox in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 OX, 0.1 OX, 1 OX and 10 OX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://oxpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://oxpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Ox Core is shutting down...") + "<br /><br />" +
