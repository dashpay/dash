...
For more information, see <a href=\"https://docs.dash.org/en/latest/wallets/dashcore/privatesend-instantsend.html\">https://docs.dash.org/en/latest/wallets/dashcore/privatesend-instantsend.html</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
