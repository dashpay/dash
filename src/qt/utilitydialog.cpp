...
These denominations are 0.01 CADEX, 0.1 CADEX, 1 CADEX and 10 CADEX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://cadexproject.atlassian.net/wiki/display/DOC/PrivateSend\">https://cadexproject.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
