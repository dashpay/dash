    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Ox Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ox address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ox: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Ox Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ox Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ox Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ox addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ox addresses"));
    ...
    openAction->setStatusTip(tr("Open a ox: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ox Core help message to get a list with possible Ox Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ox Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ox network", "", count));
}
...
{
    QString strTitle = tr("Ox Core"); // default title
