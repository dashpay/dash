    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Kriss Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Kriss address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kriss: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Kriss Core"), this);
    aboutAction->setStatusTip(tr("Show information about Kriss Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Kriss Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Kriss addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Kriss addresses"));
    ...
    openAction->setStatusTip(tr("Open a kriss: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Kriss Core help message to get a list with possible Kriss Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Kriss Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Kriss network", "", count));
    } else {
...
{
    QString strTitle = tr("Kriss Core"); // default title
