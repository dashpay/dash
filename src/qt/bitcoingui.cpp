    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BTX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BTX Core"), this);
    aboutAction->setStatusTip(tr("Show information about BTX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BTX"));
    ...
    openAction->setStatusTip(tr("Open a btx: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BTX Core help message to get a list with possible BTX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BTX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BTX network", "", count));
}
...
{
    QString strTitle = tr("BTX Core"); // default title
