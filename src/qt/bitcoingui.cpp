...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Owncoin Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Owncoin Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Owncoin Core help message to get a list with possible Owncoin Core command-line options"));
