...
<context>
    ...
    <message>
        ...
        <translation>JSON-RPC 连接要使用的用户名和散列密码。&lt;userpw&gt; 的格式是：&lt;USERNAME&gt;:&lt;SALT&gt;$&lt;HASH&gt;。在 share/rpcauth 目录下有一个示范的 python 脚本。之后客户端程序就可以用这对参数正常连接：rpcauth=&lt;USERNAME&gt;和rpcpassword=&lt;PASSWORD&gt;。这个选项可以被多次指定。</translation>
    </message>
    <message>
