...
<context>
    ...
    <message>
        ...
        <translation>Использовать 2 отдельные мастерноды для перемешивания до 5000 WAGGOX</translation>
    </message>
    <message>
        <source>Use 8 separate masternodes to mix funds up to 5000 WAGGOX</source>
        <translation>Использовать 8 отдельных мастернод для перемешивания до 5000 WAGGOX</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Это самый быстрый вариант, анонимизация 5000 WAGGOX будет стоить вам примерно 0.025 WAGGOX</translation>
    </message>
    <message>
        <source>This option is moderately fast and will cost about 0.05 WAGGOX to anonymize 5000 WAGGOX</source>
        <translation>Это относительно быстрый вариант, анонимизация 5000 WAGGOX будет стоить вам примерно 0.05 WAGGOX</translation>
    </message>
    <message>
        <source>0.1 WAGGOX per 5000 WAGGOX you anonymize.</source>
        <translation>0.1 WAGGOX за каждые анонимизированные 5000 WAGGOX.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Если ручная комиссия  установлена в 5000 duff, а транзакция по размеру только 250 байт, то плата "за килобайт" составит лишь 250 duff,&lt;br&gt;в то время как "минимум" будет равна 5000 duff. Для транзакций больше килобайта в любом случае идет расчет "за килобайт".</translation>
    </message>
    <message>
        ...
        <translation>Если ручная комиссия  установлена в 5000 duff, а транзакция по размеру только 250 байт, то плата "за килобайт" составит лишь 250 duff,&lt;br&gt;в то время как "итого минимум" будет равна 5000 duff. Для тразакций больше килобайта в любом случае идет расчет "за килобайт".</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>К waggox: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть Dash.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Максимальный размер буфера приёма на одно соединение, &lt;n&gt;*5000 байт (по умолчанию: %u)</translation>
    </message>
    <message>
        <source>Maximum per-connection send buffer, &lt;n&gt;*5000 bytes (default: %u)</source>
        <translation>Максимальный размер буфера отправки на соединение, &lt;n&gt;*5000 байт (по умолчанию: %u)</translation>
    </message>
    <message>
