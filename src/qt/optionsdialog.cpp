    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("OX-light"), QVariant("light"));
    ui->theme->addItem(QString("OX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("OX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("OX-traditional"), QVariant("trad"));
