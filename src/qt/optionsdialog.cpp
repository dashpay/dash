    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("KRISS-light"), QVariant("light"));
    ui->theme->addItem(QString("KRISS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("KRISS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("KRISS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("KRISS-traditional"), QVariant("trad"));
