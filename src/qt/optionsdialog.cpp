    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GVIDON-light"), QVariant("light"));
    ui->theme->addItem(QString("GVIDON-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GVIDON-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GVIDON-traditional"), QVariant("trad"));
