    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("KLIQ-light"), QVariant("light"));
    ui->theme->addItem(QString("KLIQ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("KLIQ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("KLIQ-traditional"), QVariant("trad"));
