...
static void SetupUIArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-platformchainid=<id>", "Override the Tenderdash chain id used by the DashPay Platform client (GUI only).", ArgsManager::ALLOW_ANY, OptionsCategory::GUI);
#endif
}
