...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "OxNetwork") type = OxNetwork;
    if(strType == "OxNetworkVariable") type = OxNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == OxNetwork) s = "OxNetwork";
    if(type == OxNetworkVariable) s = "OxNetworkVariable";
