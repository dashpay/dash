...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GvidonNetwork") type = GvidonNetwork;
    if(strType == "GvidonNetworkVariable") type = GvidonNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GvidonNetwork) s = "GvidonNetwork";
    if(type == GvidonNetworkVariable) s = "GvidonNetworkVariable";
