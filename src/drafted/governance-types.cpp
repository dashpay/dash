...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "KrissNetwork") type = KrissNetwork;
    if(strType == "KrissNetworkVariable") type = KrissNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == KrissNetwork) s = "KrissNetwork";
    if(type == KrissNetworkVariable) s = "KrissNetworkVariable";
