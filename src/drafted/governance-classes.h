 ...
 *
 *   // network
 *   COxNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ox.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class COxNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: OxNetwork
// //   -- signature requirements : Key1(User)
// class COxNetworkVariable : public CGovernanceObject
// {
// private:
