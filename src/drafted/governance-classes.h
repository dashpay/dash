 ...
 *
 *   // network
 *   COwncoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.owncoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class COwncoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    COwncoinNetwork(UniValue objIn)
    {
...
// // can be under: OwncoinNetwork
// //   -- signature requirements : Key1(User)
// class COwncoinNetworkVariable : public CGovernanceObject
// {
// private:
