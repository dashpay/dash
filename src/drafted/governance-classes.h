 ...
 *
 *   // network
 *   CKliqNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.kliq.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CKliqNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: KliqNetwork
// //   -- signature requirements : Key1(User)
// class CKliqNetworkVariable : public CGovernanceObject
// {
// private:
