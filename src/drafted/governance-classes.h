 ...
 *
 *   // network
 *   CKrissNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.kriss.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CKrissNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: KrissNetwork
// //   -- signature requirements : Key1(User)
// class CKrissNetworkVariable : public CGovernanceObject
// {
// private:
