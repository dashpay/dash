...
2. run gvidond with -printalert or -sendalert like this:
   /path/to/gvidond -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.gvidon.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Gvidon Core:0.12.0.58/"));
