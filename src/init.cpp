...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-pushnocompactfilters",
                   "Report no compact block filter support to other nodes, without changing local behaviour (regtest "
                   "only)",
                   ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
    argsman.AddArg("-pushnorelay", "Report relay=0 to other nodes, without changing local behaviour (regtest only)",
                   ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
