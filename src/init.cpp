...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-zmqpubhashinstantsenddoublespend=<address>", _("Enable hash publish of attempted InstantSend double spend in <address>"));
    ...
    strUsage += HelpMessageOpt("-zmqpubrawinstantsenddoublespend=<address>", _("Enable raw publish of attempted InstantSend double spend in <address>"));
#endif
