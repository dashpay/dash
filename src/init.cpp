...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    Consensus::Params devnetConsensus;
    Consensus::LLMQParams devnetLLMQ;
    if (gArgs.IsArgSet("-devnet")) {
        devnetConsensus = CreateChainParams(CBaseChainParams::DEVNET)->GetConsensus();
        devnetLLMQ = devnetConsensus.llmqs.at(Consensus::LLMQ_DEVNET);
    }
