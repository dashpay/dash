    ...
    const Signer& asset_lock_signer)
{
    ...
    try {
        return FromFfi(sdk.st_build_identity_create(
    ...
    const Signer& signer)
{
    ...
    try {
        ...
        return FromFfi(sdk.st_build_dpns_preorder(
    ...
    const Signer& signer)
{
    ...
    try {
        ...
        return FromFfi(sdk.st_build_dpns_domain(
    ...
    const Signer& signer)
{
    ...
    try {
        return FromFfi(sdk.st_build_profile(
    ...
    const Signer& signer)
{
    ...
    try {
        ...
        return FromFfi(sdk.st_build_contact_request(
