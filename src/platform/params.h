...
struct Params {
    ...
    //! Lowest Platform protocol version this network can be running; the
    //! SDK ratchets upward from it as verified responses report newer
    //! versions (rs-sdk min_protocol_version).
    uint32_t protocol_version_floor{0};
