...
protected:
    ...
    virtual void NotifyChainLock(const CBlockIndex* pindex, const std::shared_ptr<const chainlocks::ChainLockSig>& clsig) {}
...
public:
    ...
    void NotifyChainLock(const CBlockIndex* pindex, const std::shared_ptr<const chainlocks::ChainLockSig>& clsig, const std::string& id);
