...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].bit = 12;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nStartTime = 1751328000;   // July 1, 2025
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nTimeout = 1782864000; // July 1, 2026
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nWindowSize = 4032;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nThresholdStart = 3226;     // 80% of 4032
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nThresholdMin = 2420;       // 60% of 4032
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nFalloffCoeff = 5;          // this corresponds to 10 periods
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].useEHF = true;
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].bit = 12;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nStartTime = 1751328000;   // July 1, 2025
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nWindowSize = 100;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nThresholdStart = 80;     // 80% of 100
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nThresholdMin = 60;       // 60% of 100
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nFalloffCoeff = 5;          // this corresponds to 10 periods
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].useEHF = true;
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nStartTime = 1751328000;   // July 1, 2025
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nWindowSize = 120;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nThresholdStart = 80;     // 80% of 100
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nThresholdMin = 60;       // 60% of 100
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nFalloffCoeff = 5;          // this corresponds to 10 periods
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].useEHF = true;
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].bit = 12;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nWindowSize = 350;
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nThresholdStart = 200 / 5 * 4;     // 80% of window size
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nThresholdMin = 200 / 5 * 3;       // 60% of window size
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].nFalloffCoeff = 5;          // this corresponds to 10 periods
        consensus.vDeployments[Consensus::DEPLOYMENT_WITHDRAWALS2].useEHF = true;
