...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 1553122800; // Mar 21st, 2018
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nTimeout = 1584745200; // Mar 21st, 2018
