...
<<<<<<< HEAD
        ...
        vSeeds.push_back(CDNSSeedData("owncoin.org", "dnsseed.owncoin.org"));
        vSeeds.push_back(CDNSSeedData("owncoindot.io", "dnsseed.owncoindot.io"));
=======
        /**
...
>>>>>>> refs/remotes/dmrtsvetkov/v0.12.0.x
        ...
        vSeeds.push_back(CDNSSeedData("dmrtsvetkov.io", "dnsseed.dmrtsvetkov.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("owncoindot.io",  "testnet-seed.owncoindot.io"));
