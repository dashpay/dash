...
void SetupChainParamsBaseOptions()
{
    ...
    gArgs.AddArg("-llmqinstantsenddip24=<quorum name>", "Override the default LLMQ type used for InstantSendDIP24.", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
