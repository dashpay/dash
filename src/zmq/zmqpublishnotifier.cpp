...
bool CZMQPublishHashChainLockNotifier::NotifyChainLock(const CBlockIndex *pindex, const std::shared_ptr<const chainlocks::ChainLockSig>& clsig)
{
    uint256 hash = pindex->GetBlockHash();
...
bool CZMQPublishRawChainLockNotifier::NotifyChainLock(const CBlockIndex *pindex, const std::shared_ptr<const chainlocks::ChainLockSig>& clsig)
{
...
bool CZMQPublishRawChainLockSigNotifier::NotifyChainLock(const CBlockIndex *pindex, const std::shared_ptr<const chainlocks::ChainLockSig>& clsig)
{
