...
BlockAssembler MinerTestingSetup::AssemblerForTest(const CChainParams& params)
{
    ...
    return BlockAssembler(*sporkManager, *governance, *m_node.llmq_ctx->quorum_block_processor, *m_node.llmq_ctx->clhandler, *m_node.llmq_ctx->isman, g_evoDb, *m_node.mempool, params, options);
}
