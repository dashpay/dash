...
#define BOOST_TEST_MODULE Kriss Test Suite

#include "test_kriss.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_kriss_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
