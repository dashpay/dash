...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(2093232932329323290LL).write() == "209323299.932329990");
    BOOST_CHECK(ValueFromAmount(2093232932329323299LL).write() == "209323299.9323293232");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("209323299.93232999")), 2093232932329323290LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("209323299.9323293232")), 2093232932329323299LL);
