...
Contains files used to package notcoind/notcoin-qt
for Debian-based Linux systems. If you compile notcoind/notcoin-qt yourself, there are some useful files here.
