...
(assuming they weren't disabled during the generation of the build system) with `ctest --test-dir <build-dir>`
for CMake builds, or `make check` for Autotools builds. Further details on running
