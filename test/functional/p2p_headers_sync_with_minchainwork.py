...
class RejectLowDifficultyHeadersTest(BitcoinTestFramework):
    ...
    def test_large_reorgs_can_succeed(self):
        ...
        # Hold time constant before reconnecting so that no in-flight request
        # predates the mocktime change, which would trigger download timeouts
        # and disconnections once the sync is under way.
        self.mocktime_all(int(time.time()))
        self.reconnect_all()
