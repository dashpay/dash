...
#            "-txindex",
    ...
    def test_compactblock_reconstruction_stalling_peer(self, stalling_peer, delivery_peer):
        ...
        # Keep the compact block structurally valid, but make it unreconstructable
        # from this peer so the original in-flight request can still complete it.
        cmpct_block.shortids[0] ^= 1
