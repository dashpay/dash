...
class RPCPackagesTest(BitcoinTestFramework):
    ...
    def test_submit_child_with_parents(self, num_parents, partial_submit):
        ...
        peer.wait_for_broadcast([tx.hash for tx in package_txns])
        self.generate(node, 1)
    ...
    def test_submit_cpfp(self):
        ...
        rich_parent_result = submitpackage_result["tx-results"][tx_rich.hash]
        poor_parent_result = submitpackage_result["tx-results"][tx_poor.hash]
        child_result = submitpackage_result["tx-results"][tx_child.hash]
