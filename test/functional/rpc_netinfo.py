...
class NetInfoTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.node_two.register_mn(self, True, f"127.0.0.1:{self.node_two.mn.nodePort}", DEFAULT_PORT_PLATFORM_P2P, DEFAULT_PORT_PLATFORM_HTTP)
    ...
    def test_shims(self):
        ...
        # to auto-fill the addr field with the coreP2PAddrs[0]
