...
class AssetLocksTest(DashTestFramework):
    ...
    def run_test(self):
        ...
        self.test_withdrawals2_fork(node_wallet, node, pubkey)
    ...
    def test_withdrawals2_fork(self, node_wallet, node, pubkey):
        self.log.info("Testing asset unlock after 'withdrawals2' activation...")
        self.activate_by_name('withdrawals2', 1750)
        self.log.info(f'post-withdrawals2 height: {node.getblockcount()} credit: {self.get_credit_pool_balance()}')
